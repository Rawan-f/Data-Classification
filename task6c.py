...
# Task 6  - Train and evaluate multi-class Perceptron for each class vs. rest
train_and_evaluate_pair("Multi-Class Perceptron - Class 3 vs. Rest", train_data, train_labels, test_data, test_labels)
...
def load_data(file_path):
    ...
    with open(file_path, 'r') as file:
        for line in file:
            ...
            if values[-1] in ['class-1', 'class-3']:
...
# Task 4 - Train and evaluate classifiers for three pairs of classes (c)
train_and_evaluate_pair("Class 1 vs. Class 3", train_data, train_labels, test_data, test_labels)